...
initialization
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomecidade', 'nomecidade', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'cidade', 'ZQCidade', 'idcidade', 'nomecid', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomeestado', 'nomeestado', TWideStringField, fkLookup, 2, 0, False, '', '', '', '', 0, 'cidade', 'ZQCidade', 'idcidade', 'estado', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomecidadecob', 'nomecidadecob', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'cidade_cob', 'ZQCidade', 'idcidade', 'nomecid', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomeestadocob', 'nomeestadocob', TWideStringField, fkLookup, 2, 0, False, '', '', '', '', 0, 'cidade_cob', 'ZQCidade', 'idcidade', 'estado', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomecidadenatural', 'nomecidadenatural', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'naturalidade', 'ZQCidade', 'idcidade', 'nomecid', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZqParticipante', 'ZqParticipantenomeestadonatural', 'nomeestadonatural', TWideStringField, fkLookup, 2, 0, False, '', '', '', '', 0, 'naturalidade', 'ZQCidade', 'idcidade', 'estado', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZQImovel', 'ZQImovelnomeloteamento', 'nomeloteamento', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'loteamento_idloteamento', 'ZQLoteamento', 'idloteamento', 'apelido', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaquadra', 'quadra', TWideStringField, fkLookup, 25, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'quadra', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendalote', 'lote', TWideStringField, fkLookup, 4, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'lote', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendacodloteamento', 'codloteamento', TIntegerField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'loteamento_idloteamento', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendanometoeam', 'nometoeam', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'apelido', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendavalorvenda', 'valorvenda', TFloatField, fkData, 0, 0, False, '', '###,###,###,##0.00', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaarea', 'area', TFloatField, fkLookup, 0, 0, False, '', '###,###,##0.00', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'area', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaruafrente', 'ruafrente', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'confrontofrente', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendadedfrente', 'medfrente', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'medidafrente', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendamedfundo', 'medfundo', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'medidafundo', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendamedesquerda', 'medesquerda', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'medidaesquerda', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendameddireita', 'meddireita', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'medidadedireita', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendavalorvenal', 'valorvenal', TFloatField, fkLookup, 0, 0, False, '', '###,###.##0.00', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'valorvenal', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaconf_frente', 'conf_frente', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'confrontofrente', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaconf_fundo', 'conf_fundo', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'confrontofundo', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaconf_esquerda', 'conf_esquerda', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'confrontoesquerda', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaconf_direita', 'conf_direita', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'confrontodireita', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendalado', 'lado', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'lado', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaesquina', 'esquina', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'esquinanome', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendalinha', 'linha', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'esquinalinha', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendacurva', 'curva', TWideStringField, fkLookup, 0, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'esquinacurva', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendadisponivel', 'disponivel', TWideStringField, fkLookup, 3, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'disponivel', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendamatricula', 'matricula', TWideStringField, fkLookup, 10, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'matriculaloteamento', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaimovel_matr', 'imovel_matr', TWideStringField, fkLookup, 10, 0, False, '', '', '', '', 0, 'imovel', 'ZQImovel', 'idimovel', 'matricula', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaforma_reajuste', 'forma_reajuste', TWideStringField, fkData, 45, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaBairro', 'Bairro', TWideStringField, fkLookup, 80, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'bairro', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaCidadeIdLoteamento', 'cidade_idcidade_loteamento', TLargeintField, fkLookup, 0, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'cidade_idcidade', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaCidade', 'Cidade', TWideStringField, fkLookup, 150, 0, False, '', '', '', '', 0, 'cidade_idcidade_loteamento', 'ZQCidade', 'idcidade', 'nomecid', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendauf', 'uf', TWideStringField, fkLookup, 2, 0, False, '', '', '', '', 0, 'cidade_idcidade_loteamento', 'ZQCidade', 'idcidade', 'estado', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaNomeEmpreend', 'NomeEmpreend', TWideStringField, fkLookup, 50, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'nomeloteamento', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQVenda', 'ZQVendaApelido', 'Apelido', TWideStringField, fkLookup, 50, 0, False, '', '', '', '', 0, 'codloteamento', 'ZQLoteamento', 'idloteamento', 'apelido', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZQRecebimento', 'ZQRecebimentonomecli', 'nomecli', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'cliente', 'ZqParticipante', 'idpaticipante', 'nome_parte', True);
  RegisterRuntimeField(TDM_Tabelas, 'ZQRecebimento', 'ZQRecebimentoadversanome', 'adversanome', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'adversa', 'ZqParticipante', 'idpaticipante', 'nome_parte', True);
  ...
  RegisterRuntimeField(TDM_Tabelas, 'ZQRecebimento', 'ZQRecebimentonome_loteamento', 'nome_loteamento', TWideStringField, fkLookup, 100, 0, False, '', '', '', '', 0, 'idloteamento', 'ZQLoteamento', 'idloteamento', 'apelido', True);
