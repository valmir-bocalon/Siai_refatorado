...
var
  Frm_RelImovel02: TFrm_RelImovel02;
  nm:integer;
implementation
...
procedure TFrm_RelImovel02.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLReport1.NewPage;
end;

procedure TFrm_RelImovel02.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TFrm_RelImovel02.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLLabel15.Caption := '';
...
procedure TFrm_RelImovel02.RLReport1AfterPrint(Sender: TObject);
begin
  nm:=0;
  xconta.Value:=0;
end;
...
procedure TFrm_RelImovel02.AfterConstruction;
begin
