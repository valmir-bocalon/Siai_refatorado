...
procedure TFrm_RelVenda02.RLBand7BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if Frm_RelVenda.ZQEntrada.FieldByName('Substituicao').Value='S' then
  begin
...
procedure TFrm_RelVenda02.RLDetailGrid1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if Frm_RelVenda.ZQParcela.FieldByName('Substituicao').Value='S' then
  begin
