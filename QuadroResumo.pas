...
procedure TFrm_QuadroResumo.RLSubDetail6BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLReport1.NewPage;
end;
...
procedure TFrm_QuadroResumo.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
begin
 ...
 begin
   ...
   if (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='Comunh�o Universal de Bens') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='COMUNH�O UNIVERSAL DE BENS') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='Comunh�o de Bens') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='COMUNH�O DE BENS') then
   begin
...
{ if alltrim(DM_Tabelas.ZQCompr_dadoscidnome_cob.Value)='' then
 ...
 if ((DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='CASADO(A)') or (DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='casado(a)')) and ((DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='Comunh�o Universal de Bens') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='COMUNH�O UNIVERSAL DE BENS') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='Comunh�o de Bens') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='COMUNH�O DE BENS')) then
 begin
...
{    if empty(charrem(RLDBText57.Caption)) then
 ...
 else if ((DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='CASADO(A)') or (DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='casado(a)') or (DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='REL.ESTAVEL') or (DM_Tabelas.ZQCompr_Dados.FieldByName('estadocivil').AsString='rel.estavel')) and ((DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='COMUNH�O PARCIAL DE BENS') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='SEPARA��O DE BENS') or (DM_Tabelas.ZQCompr_conjuge.FieldByName('regime').AsString='UNI�O EST�VEL')) then
 begin
    if empty(RLDBText56.Caption) then
    begin
      RLDBText56.DataField:='';
...
procedure TFrm_QuadroResumo.RLDetailGrid2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
initialization
  ...
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento', 'recebimentodocumento', 'documento', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento', 'recebimentoValor', 'Valor', TFloatField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento', 'recebimentoordem', 'ordem', TWideStringField, fkData, 14, 0, False, '', '', '', '', 0, '', '', '', '', False);
  ...
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento', 'recebimentoTipDoc', 'TipDoc', TWideStringField, fkData, 2, 0, False, '', '', '', '', 0, '', '', '', '', False);
  ...
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequebanco', 'banco', TWideStringField, fkData, 3, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeagencia', 'agencia', TWideStringField, fkData, 6, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequedono', 'dono', TWideStringField, fkData, 50, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeCPF_CNPJ', 'CPF_CNPJ', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  ...
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequealias', 'alias', TWideStringField, fkData, 12, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeprorrogado', 'prorrogado', TDateField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeconta', 'conta', TWideStringField, fkData, 15, 0, False, '', '', '', '', 0, '', '', '', '', False);
  ...
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequenumero', 'numero', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeidvinculo', 'idvinculo', TIntegerField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequeSubstituicao', 'Substituicao', TWideStringField, fkData, 1, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'cheque', 'chequesq', 'sq', TLargeintField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeDataSet(TFrm_QuadroResumo, 'recebimento2', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2idrecebimento', 'idrecebimento', TLargeintField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2venda_idvenda', 'venda_idvenda', TIntegerField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2documento', 'documento', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2Valor', 'Valor', TFloatField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2ordem', 'ordem', TWideStringField, fkData, 14, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2Dt_Vencimento', 'Dt_Vencimento', TDateField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2TipDoc', 'TipDoc', TWideStringField, fkData, 2, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_QuadroResumo, 'recebimento2', 'recebimento2vr', 'vr', TFloatField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
