...
begin
  ...
  { O campo calculado pode ser avaliado antes dos lookups pelo FortesReport.
    Este texto e montado a partir dos dados atuais do comprador. }
...
begin
  ...
  MeasureReport(RLReport1, 'Quadro resumo');
end;
