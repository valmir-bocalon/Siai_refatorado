...
Begin
  ...
  mensagem('Ao sair desta tela, o sistema será fechado para que as atualizações sejam consideradas,'+ chr(13) +'execute novamente o sistema para poder trabalhar normalmente...');
End;
