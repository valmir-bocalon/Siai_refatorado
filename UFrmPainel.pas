...
//   ZQCalculoEst.SQL.Add('select format(sum(vlr),2,''de_DE'') as total from Custo_estoque');
   ...
   // Inserimos as informa��es de cabe�alho de
   // cada coluna
   ZQCalculoEst.First;
   ...
   if RGFiltro.ItemIndex=0 then
     ...
     PRText1.Lines.Add('Filtro por Per�odo: De: '+datetostr(dtinicio.Date)+'  �  '+datetostr(dtfinal.Date));
   ...
   PRText1.Lines.Add('');
   PRText1.Lines.Add('Total de Lotes: '+FormatFloat('###,###,##0.##',custo_compra)+'  Lotes Dispon�veis: '+FormatFloat('###,###,##0.##',custovnd)+'  Lotes n�o Dispon�veis: '+FormatFloat('###,###,##0.##',abertorec));
   PRText1.Lines.Add('Dispon�veis: '+FormatFloat('0.00',perc)+' %  - N�o Dispon�veis:'+FormatFloat('0.00',saldo)+' %');
   PRText1.Lines.Add('');
   PRText1.Lines.Add('');
