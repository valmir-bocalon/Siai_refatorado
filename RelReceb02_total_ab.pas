...
type
  TFrmRelReceb02_total_ab = class(TForm)
    RLReport1: TRLReport;
    RLBand1: TRLBand;
...
var
  FrmRelReceb02_total_ab: TFrmRelReceb02_total_ab;
  varsomabaixa : Double;
  varvar : string;
implementation
...
procedure TFrmRelReceb02_total_ab.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TFrmRelReceb02_total_ab.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TFrmRelReceb02_total_ab.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TFrmRelReceb02_total_ab.AfterConstruction;
begin
