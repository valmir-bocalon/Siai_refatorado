...
{       ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
       ...
       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where (numboleto is null or numboleto='''') and (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+')'+' and DT_Vencimento >= :dt  and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' order by DT_Vencimento,ordem,quadralote')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+')'+' and DT_Vencimento >= :dt and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' order by DT_Vencimento,ordem,quadralote');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
//       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.Open;
       ZQRecebimento.First;
...
{      ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and adversa in ('+vardevedor+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
      ...
      ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
      if CBDesconsidera.Checked=false then
         ZQRecebimento.SQL.Add(' Select * from Recebimento where ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')'+' and (DT_Vencimento >= :dt) order by DT_Vencimento,ordem,adversa')
      else
         ZQRecebimento.SQL.Add(' Select * from Recebimento where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')'+' and (DT_Vencimento >= :dt) order by DT_Vencimento,ordem,adversa');
      ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
  //    ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);
...
{       ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and idloteamento in ('+varlotea+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
       ...
       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') '+' and (DT_Vencimento >= :dt) order by DT_Vencimento,ordem,idloteamento')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')'+' and (DT_Vencimento >= :dt) order by DT_Vencimento,ordem,idloteamento');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
//       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.Open;
       ZQRecebimento.First;
...
{  ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
  ...
  if CBDesconsidera.Checked=false then
     ZQRecebimento.SQL.Add(' Select * from Recebimento where ((numboleto is null) or (numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento')
  else
     ZQRecebimento.SQL.Add(' Select * from Recebimento where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento');
...
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ');
         ...
         ZQRecebimento.SQL.Add(' where  (numboleto is null or numboleto='''') and (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento' );
       end
       else
       begin
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ' );
         ZQRecebimento.SQL.Add('update recebimento set marcar=''1''' );
         ZQRecebimento.SQL.Add(' where  (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento');
       end;
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.ExecSQL;
       ...
       ZQRecebimento.SQL.clear;
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where  (numboleto is null or numboleto='''') and (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where  (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.Open;
       ZQRecebimento.First;
     end;
...
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ');
         ZQRecebimento.SQL.Add('update recebimento set marcar=''1''');
         ZQRecebimento.SQL.Add(' where  ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento' );
       end
       else
       begin
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ' );
         ZQRecebimento.SQL.Add('update recebimento set marcar=''1''' );
         ZQRecebimento.SQL.Add(' where  ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento');
       end;
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.ExecSQL;
...
{      ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and adversa in ('+vardevedor+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
      ...
      ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
      if CBDesconsidera.Checked=false then
         ZQRecebimento.SQL.Add(' Select * from Recebimento where ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento')
      else
         ZQRecebimento.SQL.Add(' Select * from Recebimento where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')  and (DT_Vencimento >= :dt) order by DT_Vencimento');
      ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
      ZQRecebimento.Open;
      ZQRecebimento.First;
    end;
...
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ');
         ZQRecebimento.SQL.Add('update recebimento set marcar=''1''');
         ZQRecebimento.SQL.Add(' where  ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')  and (DT_Vencimento >= :dt) order by DT_Vencimento');
       end
       else
       begin
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ' );
         ZQRecebimento.SQL.Add('update recebimento set marcar=''1''' );
         ZQRecebimento.SQL.Add(' where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')  and (DT_Vencimento >= :dt) order by DT_Vencimento');
       end;
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.ExecSQL;
...
{       ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and idloteamento in ('+varlotea+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
       ...
       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')  and (DT_Vencimento >= :dt) order by DT_Vencimento')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+')  and (DT_Vencimento >= :dt) order by DT_Vencimento');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.Open;
       ZQRecebimento.First;
     end;
...
//         ZQRecebimento.SQL.Add('update recebimento set marcar= case when (marcar=''1'') then ''0'' when (marcar=''0'') then ''1'' end ' );
       ...
       ZQRecebimento.SQL.clear;
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and (numboleto is null or numboleto='''') and (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and  (Parcelas_fixas<>''S'' or Parcelas_fixas is null ) and  TipDoc=''BO'' and saldo>''0'' and quadralote in ('+varquadra+') and Proximo_Reajuste ='+quotedstr(lmes.caption+'/'+xano.text)+' and DT_Vencimento >= :dt order by DT_Vencimento');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
       ZQRecebimento.Open;
       ZQRecebimento.First;
     end;
...
{      ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and adversa in ('+vardevedor+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
      ...
      ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
      if CBDesconsidera.Checked=false then
         ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento')
      else
         ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (adversa in ('+vardevedor+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento');
      ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);
      ZQRecebimento.Open;
      ZQRecebimento.First;
    end;
...
{       ZQRecebimento.SQL.Add(' Select * from Recebimento where TipDoc=''BO'' and saldo>''0'' and idloteamento in ('+varlotea+')'+' and DT_Vencimento >= :dt and DT_Vencimento <= :dt2 order by DT_Vencimento');
       ...
       ZQRecebimento.ParamByName('dt2').AsDate:=strtodate(ms+'/'+lmes.caption+'/'+xano.text);}
       if CBDesconsidera.Checked=false then
          ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and ((numboleto is null or numboleto='''')) and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') and (DT_Vencimento >= :dt) order by DT_Vencimento')
       else
          ZQRecebimento.SQL.Add(' Select * from Recebimento where marcar=''0'' and ((Parcelas_fixas<>''S'' or Parcelas_fixas is null )) and (TipDoc=''BO'') and (saldo>''0'') and (idloteamento in ('+varlotea+')'+') and (Proximo_Reajuste='+quotedstr(lmes.caption+'/'+xano.text)+') (DT_Vencimento >= :dt) order by DT_Vencimento');
       ZQRecebimento.ParamByName('dt').AsDate:=strtodate('01/'+lmes.caption+'/'+xano.text);          
       ZQRecebimento.Open;
       ZQRecebimento.First;
     end;
...
{  ZQRecebtmp.first;
  ...
  begin
    barra2.Position:=ZQRecebimento.recno;
    ZQRecebtmp.Append;
    ZQRecebtmpidrecebimento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('idrecebimento').Value;
    ZQRecebtmpdocumento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('documento').Value;
    ZQRecebtmpcliente.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('cliente').Value;
    ZQRecebtmpusuario.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('usuario').Value;
    ZQRecebtmpDt_Entrada.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Dt_Entrada').Value;
    ZQRecebtmpDt_Vencimento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Dt_Vencimento').Value;
    ZQRecebtmpValor.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Valor').Value;
    ZQRecebtmpVrDoc.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('VrDoc').Value;
    ZQRecebtmpordem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('ordem').Value;
    ZQRecebtmpTipDoc.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('TipDoc').Value;
    ZQRecebtmpsaldo.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('saldo').Value;
    ZQRecebtmporigem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('origem').Value;
    ZQRecebtmpadversa.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('adversa').Value;
    ZQRecebtmprecpag.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('recpag').Value;
    ZQRecebtmpnumordem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('numordem').Value;
    ZQRecebtmpadversanome.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('adversanome').Value;
    ZQRecebtmpidloteamento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('idloteamento').Value;
    ZQRecebtmpvenda_idvenda.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('venda_idvenda').Value;
    ZQRecebtmpquadralote.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('quadralote').Value;
    ZQRecebtmpnomeadversa.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('nomeadversa').Value;
    ZQRecebtmpParcelas_fixas.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Parcelas_fixas').Value;
    ZQRecebtmpnome_loteamento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('nome_loteamento').Value;
  ...
  begin
    barra2.Position:=ZQRecebimento.recno;
    ZQRecebtmp2.Append;
    ZQRecebtmp2idrecebimento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('idrecebimento').Value;
    ZQRecebtmp2documento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('documento').Value;
    ZQRecebtmp2cliente.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('cliente').Value;
    ZQRecebtmp2usuario.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('usuario').Value;
    ZQRecebtmp2Dt_Entrada.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Dt_Entrada').Value;
    ZQRecebtmp2Dt_Vencimento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Dt_Vencimento').Value;
    ZQRecebtmp2Valor.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Valor').Value;
    ZQRecebtmp2VrDoc.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('VrDoc').Value;
    ZQRecebtmp2ordem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('ordem').Value;
    ZQRecebtmp2TipDoc.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('TipDoc').Value;
    ZQRecebtmp2saldo.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('saldo').Value;
    ZQRecebtmp2origem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('origem').Value;
    ZQRecebtmp2adversa.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('adversa').Value;
    ZQRecebtmp2recpag.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('recpag').Value;
    ZQRecebtmp2numordem.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('numordem').Value;
    ZQRecebtmp2adversanome.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('adversanome').Value;
    ZQRecebtmp2idloteamento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('idloteamento').Value;
    ZQRecebtmp2venda_idvenda.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('venda_idvenda').Value;
    ZQRecebtmp2quadralote.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('quadralote').Value;
    ZQRecebtmp2nomeadversa.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('nomeadversa').Value;
    ZQRecebtmp2Parcelas_fixas.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('Parcelas_fixas').Value;
    ZQRecebtmp2nome_loteamento.Value:=Frm_ReajusteDeParcelas2.ZQRecebimento.FieldByName('nome_loteamento').Value;
...
initialization
  ...
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1lado', 'lado', TWideStringField, fkData, 5, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1medidafrente', 'medidafrente', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1medidafundo', 'medidafundo', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1medidaesquerda', 'medidaesquerda', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1medidadedireita', 'medidadedireita', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1area', 'area', TFloatField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1confrontofrente', 'confrontofrente', TWideStringField, fkData, 50, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1confrontofundo', 'confrontofundo', TWideStringField, fkData, 50, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1confrontodireita', 'confrontodireita', TWideStringField, fkData, 50, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1confrontoesquerda', 'confrontoesquerda', TWideStringField, fkData, 50, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1esquinanome', 'esquinanome', TWideStringField, fkData, 100, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1esquinalinha', 'esquinalinha', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1esquinacurva', 'esquinacurva', TWideStringField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1valorvenal', 'valorvenal', TFloatField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1Obervacaoloteamento', 'Obervacaoloteamento', TWideMemoField, fkData, 0, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1cornomapa', 'cornomapa', TWideStringField, fkData, 10, 0, False, '', '', '', '', 0, '', '', '', '', False);
  RegisterRuntimeField(TFrm_ReajusteDeParcelas2, 'ZQVen1', 'ZQVen1disponivel', 'disponivel', TWideStringField, fkData, 3, 0, False, '', '', '', '', 0, '', '', '', '', False);
